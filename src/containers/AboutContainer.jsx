import { Avatar, chakra, Flex, HStack, Icon, Link, Tag, Text, useColorModeValue, VStack } from "@chakra-ui/react";
    ...
    return (
      <HStack spacing={4}>
        ...
        <Flex flexDirection="column" justifyContent="start" alignItems="start">
          <Text fontSize={["xl", "xl", "2xl"]} fontWeight="700"
                color={useColorModeValue("gray.800", "gray.200")}>{name}</Text>
          <Flex w="100%" flexWrap="wrap" alignItems="center" css={{ gap: "0.5em" }}>
            <Text mr="2" fontSize={["sm", "md"]} fontWeight="500"
                  color={useColorModeValue("gray.600", "gray.400")}>{position}</Text>
      ...
      <Flex w="100%" minH="85vh" justifyContent="start" alignItems="start" flexDirection="column" flexWrap="wrap">
        ...
        >
          <Flex w="100%" justifyContent="start" alignItems="start" flexDirection="column">
            <HStack spacing="2">
              <Text fontSize={["3xl", "4xl", "5xl"]} fontWeight="600"
                    color={useColorModeValue("gray.600", "gray.400")}>Hi</Text>
              <motion.div
              ...
              <Text fontSize={["3xl", "4xl", "5xl"]} fontWeight="600"
                    color={useColorModeValue("gray.600", "gray.400")}>I'm</Text>
              <Text fontSize={["3xl", "4xl", "5xl"]} fontWeight="700"
                    color={useColorModeValue("gray.800", "gray.300")}>James.</Text>
            </HStack>
            <Text mt="6" mb="4" fontSize={["3xl", "4xl", "5xl"]} fontWeight="600"
                  color={useColorModeValue("gray.500", "gray.500")} lineHeight="shorter">
              A
            ...
            <Text mb="4" fontSize={["3xl", "4xl", "5xl"]} fontWeight="600"
                  color={useColorModeValue("gray.500", "gray.500")} lineHeight="shorter">
              I am experienced in
            ...
            <HStack mt="8" spacing={["8", "16"]}>
              <Link href="resume">
                <HStack spacing="2">
                  ...
                  <Text fontSize={["md", "xl", "3xl"]} fontWeight="600"
        ...
        <Flex id="experience" w="100%" pt="16" pb="32" px={{ base: "8", md: "16", xl: "36" }} flexDirection="row"
              justifyContent={{ base: "space-between" }} bg={bg_color} flexWrap="wrap" gap="8">
          <Flex
            justifyContent="start"
            alignItems="start"
            flexDirection="column"
          >
            <Text mb="4" fontSize="4xl" fontWeight="700"
                  color={useColorModeValue("gray.800", "gray.200")}>Education</Text>
            ...
            <Icon w={["32px", "48px", "64px"]} as={BsThreeDotsVertical}
          ...
          >
            <Text mb="4" fontSize="4xl" fontWeight="700"
                  color={useColorModeValue("gray.800", "gray.200")}>Experience</Text>
