...
import { Flex, HStack, IconButton, Image, Text, useColorModeValue } from "@chakra-ui/react";
...
function HomeContainer() {
  ...
  const smallBanner = (emoji, title, color) => {
    return (
      <HStack w={["80vw", "80vw", "80vw", "30vw"]} px="4" py="4" mt="8" justifyContent="center" spacing={4}
              flexDirection="row" bg={color} borderRadius="xl" boxShadow="xl">
  ...
  return (
    <Flex flexDirection="column" alignItems="center" justifyContent="start" bg={useColorModeValue("white", "gray.900")}>
      ...
      <WelcomeContainer />
      <motion.div animate={{ y: [-20, 0, -20], scale: [1.1, 1, 1.1] }}
                  transition={{ delay: 2, repeat: Infinity, repeatType: "reverse", duration: 2, repeatDelay: 1 }}>
        <HashLink to="/#about" smooth>
          <IconButton mt="4" mb="10vh" icon={<FaArrowDown size="1.5em" />} aria-label="GitHub" variant="ghost"
